import {Injectable, BadRequestException, InternalServerErrorException, ConsoleLogger} from "@nestjs/common";
...
export class GatewayService {
    ...
    constructor(private readonly configService: ConfigService) {
        this.services = this.configService.get<Record<string, ServiceConfig>>('services');
    }
    ...
    async forward(
        ...
        if (missingUrl) {
            throw new BadRequestException(`서비스 URL이 지정되지 않았습니다: ${serviceKey}`);
        }
